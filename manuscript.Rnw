...
<<bechtel_amce, dependson=c("data_bechtel")>>=
plot(cj(bechtel, choice_cj ~ cost_cj + distrib_cj + ctries_cj + emissions_cj + sanctions_cj + monitoring_cj, weights = ~ weight, id = ~ ID, estimate = "amce"))
@
...
<<bechtel_mm, dependson=c("data_bechtel")>>=
plot(cj(bechtel, choice_cj ~ cost_cj + distrib_cj + ctries_cj + emissions_cj + sanctions_cj + monitoring_cj, weights = ~ weight, id = ~ ID, estimate = "mm"), vline = 0.5)
@
