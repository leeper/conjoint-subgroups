...
<<hainmueller_subgroup_example, dependson=c("data_hainmueller_immigration"), fig.cap="Comparison of Subgroup AMCEs Using Alternative Reference Categories for Hainmueller et al. (2014) Immigration Experiment">>=
