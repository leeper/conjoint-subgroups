...
<<bms_difference_comparison, dependson=c("data_bms"), fig.width=8, fig.height=4, fig.cap="Estimated Preferences Difference between Inequity Averse and Non-Averse Respondents from Ballard-Rosa et al. (2016) Tax Preference Experiment">>=
# reported results
...
amce_diffs$statistic <- "Difference in AMCEs"
...
levels(diffs$statistic) <- c("Originally Reported Difference", "Difference in AMCEs", "Difference in MMs")
# Plot
...
<<hainmueller_subgroup_example, dependson=c("data_hainmueller_immigration"), fig.cap="Comparison of Alternative Reference Categories for Hainmueller et al. (2014) immigration Experiment">>=
...
<<hainmueller_subgroup_example_plot, dependson=c("data_hainmueller_immigration", "hainmueller_subgroup_example"), fig.width=8, fig.height=12, fig.cap="Alternative Reference Categories for Features in Hainmueller et al. (2014) Immigration Experiment", message=FALSE>>=
